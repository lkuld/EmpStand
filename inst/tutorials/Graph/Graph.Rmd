---
title: "Grafiken in R mit ggplot2"
...
***Die folgenden Pakete sind bereits geladen: EmpStand, stringr, ggplot2 und sf (Karten).***

ggplot2 (Prinzip basierend auf Leland Wilkinson, The Grammar of Graphics, Springer, 1999, deswegen 'gg')  bietet eine riesige Anzahl statischer Graphiken, z.B. Histogramme, Karten und scatterplots, um Datensätze zu veranschaulichen.

Das Grundprinzip ist, dass wir nacheinander verschiedene _Layer_ definieren. Z.B. starten wir mit einem leeren Kaste in den wir dann Linien und Punkte einzeichnen.

Schauen wir uns nochmal den Bairoch Datensatz zu Bevolkerungsgroesse an.
